package com.cyberknight.weather.bluetooth_connectivity;
...
public class BluetoothChat extends Activity {
    ...
    private List<com.cyberknight.weather.bluetooth_connectivity.Message> messageList = new ArrayList<com.cyberknight.weather.bluetooth_connectivity.Message>();
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_WRITE:
                    ...
                    linearLayoutManager.scrollToPosition(mAdapter.getItemCount());
                    messageList.add(new com.cyberknight.weather.bluetooth_connectivity.Message(counter++, writeMessage, "Me"));
                    break;
                case MESSAGE_READ:
